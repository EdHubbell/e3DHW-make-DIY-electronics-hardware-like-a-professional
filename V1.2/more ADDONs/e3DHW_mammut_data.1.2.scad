...
*/
/**
 @file e3DHW_mammut_data.1.2.scad
 Collection of commercial mammut data, used by e3DHW_addon_terminal.1.2.scad.
...
//
// note: if len(MAMMUT) > 5 you must update the function _get_MIdx() in e3DHW_addon_terminal.1.2.scad !!
//
